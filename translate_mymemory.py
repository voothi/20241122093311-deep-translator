...
parser = argparse.ArgumentParser(description="Translate text using MyMemoryTranslator.")
...
try:
    try:
        translator = MyMemoryTranslator(source=args.source, target=args.target, **translator_kwargs)
    except TypeError:
